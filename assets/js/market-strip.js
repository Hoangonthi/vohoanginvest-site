...
export async function initMarketStrip() {
  ...
  section.innerHTML = `<div class="market-overview-inner"><div class="market-overview-head"><div class="market-overview-title"><i aria-hidden="true"></i><span>Thị trường Việt Nam</span><button class="market-overview-toggle" type="button" data-market-toggle>Xem đủ</button></div><div class="market-overview-status" data-market-status>Đang tải dữ liệu…</div></div><div class="market-index-grid" data-market-grid></div></div>`;
  ...
  toggle?.addEventListener("click", () => { const expanded = section.classList.toggle("is-expanded"); toggle.textContent = expanded ? "Thu gọn" : "Xem đủ"; });
}
